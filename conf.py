...
BLOG_AUTHOR = "Azzam"  # (translatable)
BLOG_TITLE = "Azzam Zafar"  # (translatable)
...
BLOG_EMAIL = "azzam.zafar21@gmail.com"
BLOG_DESCRIPTION = "Portfolio Blog"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ("/blog-roll", "Blog Roll"),
        ("/2023/","2023"),
        ("https://github.com/azzamzafar","Github")
    ),
}
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="mailto:{email}">{author}</a></a>  {license}'
